...
const Home = () => {
  ...
  return (
    ...
    >
      <div>
        <EditWindow
          myRef={windows[windowID]?.ref}
          index={editingIndex}
          task={editingTask[editingIndex]}
        ...
        {windows.map((window, index) => {
          return (
            <TaskWindow
              ref={windows[index]?.ref}
              key={index}
              mousePosition={mousePosition}
              containerId={index}
              startingName={window.name}
